  ...
  return (
    <div className='space-y-16 lg:space-y-32'>
      ...
      <div className='relative rounded-2xl overflow-hidden mx-3 sm:mx-4 md:mx-6 mt-3 sm:mt-4 md:mt-6 h-[calc(100dvh-2rem)] min-h-150 md:min-h-175'>
        {/* Background Image */}
        <Image
          src='https://www.pipeout247.co.uk/wp-content/uploads/2025/03/Reliable-Plumber-Essex-scaled.jpeg'
          alt={`${lead?.businessName || 'Plumber'} - Professional Plumbing Repair`}
          fill
          priority
      ...
      <section className='max-w-7xl px-4 md:px-6 mx-auto'>
        <div className='flex flex-col lg:flex-row gap-12 lg:gap-20 items-stretch'>
          ...
          <div className='flex-1 relative group'>
            ...
            <Image
              src='https://www.banham.co.uk/media/wysiwyg/pipe-repair-body.png'
              alt='Professional Plumbing Repair and Installation'
              height={800}
              width={800}
          ...
          <div className='flex-1 flex flex-col bg-white p-6 sm:p-8 lg:p-12 rounded-2xl shadow-sm border border-gray-100 justify-center group hover:border-[#ff6333]/30 transition-all ease-in-out duration-500'>
            <div className='space-y-6'>
              <div className='flex items-center gap-3'>
                ...
                <span className='text-(--brand-orange) font-bold tracking-widest uppercase text-sm'>Local Plumbing Experts</span>
              </div>

              <h2 className='text-3xl sm:text-4xl lg:text-5xl text-gray-900 font-bold leading-tight tracking-tight'>
                Emergency Plumber & <br className='hidden sm:block' />
                <span className='text-transparent bg-clip-text bg-linear-to-r from-gray-900 to-gray-500'>Plumbing Solutions</span>
              </h2>

              <div className='space-y-4 text-gray-600 text-base sm:text-lg leading-relaxed'>
                <p>
                  At <span className='font-bold text-gray-900 capitalize'>{lead?.businessName || 'our company'}</span>, we understand that plumbing
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
            {[
              ...
              },
              {
                ...
                desc: 'We use specialist techniques and diagnostic equipment to solve your problem quickly and safely.',
              },
              { num: '04', title: 'Fixed & Resolved', desc: 'Your plumbing is fixed, and we ensure you are 100% satisfied before we leave.' },
            ].map((step, idx) => (
              <div
                key={idx}
        ...
        <div className='grid md:grid-cols-3 gap-6'>
          ...
          <div className='md:col-span-2 bg-(--dark-bg) rounded-2xl p-6 sm:p-8 lg:p-12 text-white relative overflow-hidden group'>
            <div className='absolute right-0 bottom-0 opacity-10 group-hover:scale-110 transition-all ease-in-out duration-500 pointer-events-none'>
              <Wrench className='w-48 h-48 sm:w-64 sm:h-64 translate-x-12 translate-y-12 sm:translate-x-0 sm:translate-y-0' strokeWidth={1} />
            </div>
          ...
          {[
            {
              ...
              desc: 'Advanced electronic and acoustic leak detection to find hidden leaks quickly.',
              icon: ShieldCheck, // Changed from Search to ShieldCheck since Search isn't imported yet
            },
            {
              id: 'drain-cleaning',
              tag: 'Maintenance',
              title: 'Drain Cleaning & Unblocking',
              desc: 'Professional clearing of stubborn clogs, tree root removal, and high-pressure jetting.',
              icon: Shield, // Changed from Droplet
            },
            {
              id: 'water-heaters',
              tag: 'Installation',
              title: 'Water Heater Installation & Repair',
              desc: 'Expert installation and repair of traditional tank and modern tankless heating systems.',
              icon: Star, // Changed from Flame
            },
            {
              id: 'boiler-services',
              tag: 'Heating',
              title: 'Boiler Servicing & Installation',
              desc: 'Comprehensive boiler diagnostics, annual servicing, repairs, and efficient new installations.',
              icon: Award, // Changed from Thermometer
            },
            {
              id: 'kitchen-bathroom',
              tag: 'Renovation',
              title: 'Bathroom & Kitchen Plumbing',
              desc: 'Complete plumbing solutions including sinks, toilets, showers, taps, and appliance hookups.',
              icon: Home, // Changed from Bath
            },
            {
              id: 'pipe-replacement',
              tag: 'Repair',
              title: 'Pipe Repair & Replacement',
              desc: 'Full or partial repiping services, resolving low water pressure, and replacing old pipes.',
              icon: Wrench,
            },
          ].map((srv, idx) => (
            <Link
          ...
          <div className='grid lg:grid-cols-2 gap-12 lg:gap-16 items-center'>
            <div>
              ...
              <h2 className='text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 tracking-tight'>
                Why Thousands Trust Us With Their Plumbing
              </h2>
              <p className='text-base sm:text-lg text-gray-500 mb-10'>
                We don&apos;t just install pipes; we deliver complete peace of mind. Our reputation is built on reliability, transparency, and expert
                craftsmanship.
              </p>
            ...
            <div className='relative'>
              ...
              <Image
                src='https://www.banham.co.uk/media/catalog/category/plumber_scams_header.jpg'
                alt='Trusted Plumber'
                height={600}
                width={600}
            ...
            {[
              {
                ...
                role: 'Homeowner',
                quote:
                  'I had a major leak at 2 AM on a Sunday. They arrived in exactly 20 minutes, isolated the water supply without making a mess, and charged exactly what was quoted on the phone. Highly recommend!',
              },
              {
                name: 'David Thompson',
                role: 'Retail Store Manager',
                quote:
                  'Upgraded our shop plumbing with their commercial package. The team was incredibly knowledgeable, explained the new piping systems clearly, and did a perfectly clean installation.',
              },
              {
                name: 'Emma Watts',
                role: 'Landlord',
      ...
      <section className='max-w-6xl mx-auto px-4 md:px-6 mb-8 md:mb-16'>
        <div className='bg-(--brand-orange) rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 text-center relative overflow-hidden'>
          ...
          <div className='relative z-10 max-w-2xl mx-auto'>
            ...
            <h2 className='text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6'>Ready To Resolve Your Plumbing Issues?</h2>
            <p className='text-white/90 text-lg sm:text-xl font-medium mb-8 sm:mb-10'>
              Don&apos;t leave your plumbing to chance. Get a free, no-obligation quote or request immediate emergency assistance today.
            </p>
    ...
    <div className='bg-gray-50 flex-1 w-full'>
      ...
      <div className='relative rounded-2xl overflow-hidden mx-3 sm:mx-4 mt-3 sm:mt-4 h-[40vh] min-h-87.5 max-h-112.5 mb-12 sm:mb-16'>
        ...
        <div className='absolute inset-0 z-30 container mx-auto max-w-7xl flex flex-col justify-end pb-8 sm:pb-12 px-4 md:px-6'>
          <h1 className='text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight'>Comprehensive Plumbing Solutions</h1>
          <p className='text-gray-300 mt-4 text-base sm:text-lg md:text-xl max-w-2xl border-l-2 border-(--brand-orange) pl-4'>
            From emergency water leaks to enterprise-grade repiping, our certified specialists are equipped to handle any situation with speed and
            precision.
          </p>
        </div>
      </div>
        ...
        <Container>
          <div className='text-center max-w-3xl mx-auto mb-16'>
            ...
            <p className='text-gray-500 text-lg'>
              We don&apos;t just fix pipes; we provide peace of mind through certified expertise and transparent practices.
            </p>
          </div>
            ...
            <div className='prose prose-lg max-w-none text-gray-600 prose-headings:text-gray-900 prose-a:text-(--brand-orange) prose-strong:text-gray-900 prose-li:marker:text-[--brand-orange]'>
              {service.htmlContent ? (
                ...
                <>
                  ...
                  <p>
                    Every plumbing situation is unique, and our approach to {service.title.toLowerCase()} reflects that. We use industry-approved
                ...
                {[
                  {
                    ...
                    desc: 'We evaluate your specific plumbing needs or emergency situation immediately upon arriving at your property.',
                  },
                  {
                    step: '02',
                  ...
                  },
                  {
                    ...
                    desc: 'Our certified engineers complete the work using British Standard materials, ensuring long-lasting plumbing and compliance.',
                  },
                ].map((process, i) => (
  ...
  return (
    <div className='bg-gray-50 flex-1 w-full'>
      ...
      <div className='relative rounded-2xl overflow-hidden mx-3 sm:mx-4 mt-3 sm:mt-4 h-[40vh] min-h-87.5 max-h-112.5 mb-12 sm:mb-16'>
        ...
        <div className='absolute inset-0 bg-black/75 z-10' />
        <div className='absolute inset-0 z-30 container mx-auto max-w-7xl flex flex-col justify-end pb-8 sm:pb-12 px-4 md:px-6'>
          <h1 className='text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight'>Plumbing Advice & News</h1>
          <p className='text-gray-300 mt-4 text-base sm:text-lg md:text-xl max-w-2xl border-l-2 border-(--brand-orange) pl-4'>
          ...
          {post.htmlContent ? (
            ...
            <>
              ...
              <p>
                ...
                advise checking that your plumbing systems are regularly serviced to prevent unexpected leaks and burst pipes.
              </p>
              <blockquote>
                &quot;An ounce of prevention is worth a pound of cure, especially when it comes to the safety of your family and property.&quot;
              </blockquote>
              <p>If you have questions about upgrading your plumbing or need an immediate assessment, do not hesitate to contact our expert team.</p>
            </>
          )}
        </article>
      </Container>
